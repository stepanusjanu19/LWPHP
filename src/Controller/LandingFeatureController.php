...
class LandingFeatureController extends Controller
{
    public function __construct(
        private readonly LandingFeatureService $service
    ) {
        parent::__construct();
    }
    ...
    public function index(Request $request, array $args): Response
    {
        ...
        return $this->render('landing_features/index', ['items' => $items]);
    }

    public function feed(Request $request, array $args): Response
    {
        $items = $this->service->getAll(); 
        return $this->render('landing_features/feed', ['items' => $items]);
    }

    public function create(Request $request, array $args): Response
    {
        return $this->render('landing_features/form');
    }
    ...
    public function edit(Request $request, array $args): Response
    {
        ...
        if (!$item) {
            return $this->notFound('LandingFeature', $id);
        }

        return $this->render('landing_features/form', ['item' => $item]);
    }
