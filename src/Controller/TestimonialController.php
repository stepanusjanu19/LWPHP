...
class TestimonialController extends Controller
{
    ...
    public function index(Request $request, array $args): Response
    {
        ...
        return $this->render('testimonials/index', ['items' => $items]);
    }

    public function feed(Request $request, array $args): Response
    {
        $items = $this->service->getAll(); 
        return $this->render('testimonials/feed', ['items' => $items]);
    }
    ...
    public function edit(Request $request, array $args): Response
    {
        ...
        if (!$item) {
            return $this->notFound('Testimonial', $id);
        }

        return $this->render('testimonials/form', ['item' => $item]);
    }
