...
use Kei\Lwphp\Service\CategoryService;
...
class CategoryController extends Controller
{
    ...
    public function index(Request $request, array $args): Response
    {
        ...
        return $this->render('categorys/index', ['items' => $items]);
    }

    public function feed(Request $request, array $args): Response
    {
        $items = $this->service->getAll(); 
        return $this->render('categorys/feed', ['items' => $items]);
    }

    public function create(Request $request, array $args): Response
    {
        return $this->render('categorys/form');
    }
    ...
    public function edit(Request $request, array $args): Response
    {
        ...
        if (!$item) {
            return $this->notFound('Category', $id);
        }

        return $this->render('categorys/form', ['item' => $item]);
    }
