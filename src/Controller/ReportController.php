...
use Kei\Lwphp\Service\ReportService;
...
class ReportController extends Controller
{
    ...
    public function index(Request $request, array $args): Response
    {
        ...
        return $this->render('reports/index', ['items' => $items]);
    }

    public function feed(Request $request, array $args): Response
    {
        $items = $this->service->getAll(); 
        return $this->render('reports/feed', ['items' => $items]);
    }

    public function create(Request $request, array $args): Response
    {
        return $this->render('reports/form');
    }
    ...
    public function edit(Request $request, array $args): Response
    {
        ...
        if (!$item) {
            return $this->notFound('Report', $id);
        }

        return $this->render('reports/form', ['item' => $item]);
    }
