...
use Kei\Lwphp\Service\UnitService;
...
class UnitController extends Controller
{
    ...
    public function index(Request $request, array $args): Response
    {
        ...
        return $this->render('units/index', ['items' => $items]);
    }

    public function feed(Request $request, array $args): Response
    {
        $items = $this->service->getAll(); 
        return $this->render('units/feed', ['items' => $items]);
    }
    ...
    public function edit(Request $request, array $args): Response
    {
        ...
        if (!$item) {
            return $this->notFound('Unit', $id);
        }

        return $this->render('units/form', ['item' => $item]);
    }
