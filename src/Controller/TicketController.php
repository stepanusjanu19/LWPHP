...
use Kei\Lwphp\Service\TicketService;
...
class TicketController extends Controller
{
    ...
    public function index(Request $request, array $args): Response
    {
        ...
        return $this->render('tickets/index', ['items' => $items]);
    }

    public function feed(Request $request, array $args): Response
    {
        $items = $this->service->getAll(); 
        return $this->render('tickets/feed', ['items' => $items]);
    }
    ...
    public function edit(Request $request, array $args): Response
    {
        ...
        if (!$item) {
            return $this->notFound('Ticket', $id);
        }

        return $this->render('tickets/form', ['item' => $item]);
    }
